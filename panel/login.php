                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="../php/loginAuth.php" method="POST">
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="register.php">Üye Ol!</a>
                                    </div>
                                    <div class="text-center">
                                        <a class="small" href="../index.php">Anasayfaya Dön!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
